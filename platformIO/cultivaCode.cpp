...
void menu_Principal(){  //_________________________________________________________________________________________________________________________________________Menu Principal
  ...
  do{
    ...
    switch( selecMenu ){
      ...
      lcd.clear();
      lcd.setCursor(0, 0);
      lcd.print("Se activa la iluminacion segun configuracion horaria");
      digitalWrite(pin_rele_valvula,LOW);
      digitalWrite(51,LOW);
      digitalWrite(49,LOW);
      digitalWrite(47,LOW);
...
//_______________________________________________________________________________________________________________________Presionar Boton
  // PROCEDIMIENTO QUE COMPRUEBA SI HA HABIDO NUEVAS PULSACIONES CON LOS BOTONES:
void presionarBoton(int &cont_reposoLCD_2){
  int tolerancia=10;
